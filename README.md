...
- YOLOv5s 및 YOLOv5su 모델을 사용한 실시간 객체 탐지
...
3. YOLOv5 ONNX 모델을 가져옵니다
   ...
   - ✅ YOLOv5 기본 모델(yolov5s.pt) 및 커스텀 모델(yolov5su.pt)도 동일하게 변환하여 사용할 수 있습니다
...
5. 탐지 결과(바운딩 박스, 클래스 ID, 신뢰도 점수)가 추출됩니다
6. Non-Maximum Suppression(NMS)을 적용하여 중복 탐지를 필터링합니다
